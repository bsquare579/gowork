...
<div class="container-fluid">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="5000">
      <img src="{{url('/img/carousel-1.jpg')}}" class="d-block w-100" alt="my">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="text-white text-uppercase mb-md-3">First slide label</h5>
        <p class="text-white mb-md-4">Some representative placeholder content for the first slide.</p>
        <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Reserve Now</a>
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="{{url('/img/carousel-2.jpg')}}" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="text-white text-uppercase mb-md-3">Second slide label</h5>
        <p class="text-white mb-md-4">Some representative placeholder content for the second slide.</p>
        <a href="" class="btn btn-success py-md-3 px-md-5 mt-2">Reserve Now</a>
      </div>
    </div>
    <div class="carousel-item">
      <img src="{{url('/img/carousel-1.jpg')}}" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="text-white text-uppercase mb-md-3">Third slide label</h5>
        <p class="text-white mb-md-4">Some representative placeholder content for the third slide.</p>
        <a href="" class="btn btn-light py-md-3 px-md-5 mt-2">Reserve Now</a>
      </div>
    </div>
  </div>
